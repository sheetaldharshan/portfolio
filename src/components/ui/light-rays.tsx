import { useEffect, useState, forwardRef, type CSSProperties } from "react"
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div
            ...
            style={
              {
                background:
                  "radial-gradient(circle at 20% 15%, color-mix(in srgb, var(--light-rays-color) 35%, transparent), transparent 70%)",
              } as CSSProperties
            }
          />
          <div
            ...
            style={
              {
                background:
                  "radial-gradient(circle at 80% 10%, color-mix(in srgb, var(--light-rays-color) 25%, transparent), transparent 75%)",
              } as CSSProperties
            }
          />
          {rays.map((ray) => (
